# Hawthorn Scapes AI Guide

This is an Astro + Tailwind CSS site for Hawthorn Scapes LLC.
...
- Use Node.js `>=22.12.0`.
- Prefer existing Astro components and Tailwind utility patterns.
- Keep public copy specific to Hawthorn Scapes and Colorado landscaping.
- Avoid reintroducing template brand names or generic construction-product content.
