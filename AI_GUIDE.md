...
| Pages                   | [src/pages/](src/pages/)           | Astro file-based routing.                                                                                                                                                                        |
...
| Navigation & UI helpers | [src/utils/](src/utils/)           | [navigation.ts](src/utils/navigation.ts) exports default `{ navBarLinks, footerLinks, socialLinks }`. |
| Site config & JSON data | [src/data_files/](src/data_files/) | [constants.ts](src/data_files/constants.ts): SITE, SEO, OG, partnersData; faqs.json, features.json, pricing.json, mega_link.ts.                                                                 |
...
- Navigation/footer copy: edit [src/utils/navigation.ts](src/utils/navigation.ts); Navbar/Footer receive the default export as `strings`.
