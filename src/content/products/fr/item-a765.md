...
main:
  ...
  imgCard: '@/images/features-image.avif'
  imgMain: '@/images/hero-image.avif'
  imgAlt: 'Detail de massif paysager sobre en eau et paysage du Colorado'
tabs:
...
blueprints:
  first: '@/images/before-after.avif'
  second: '@/images/aerial-view.avif'
---
