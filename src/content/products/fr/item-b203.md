...
main:
  ...
  imgCard: '@/images/before-after.avif'
  imgMain: '@/images/aerial-view.avif'
  imgAlt: 'Transformation paysagere et vue d ensemble d une propriete amenagee'
tabs:
